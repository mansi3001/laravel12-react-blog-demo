        ...
        switch (field.type) {
            ...
            case 'select':
                if (mode === 'view') {
                    ...
                    return <div className="rounded-md border bg-gray-50 p-2">{selectedOption?.label || value || '-'}</div>;
                }
                return (
                    <Select
                        value={String(value || '')}
                        ...
                        {value && value instanceof File && isImageFile && (
                            <div className="mt-2">
                                ...
                                <img
                                    ...
                                    alt="Preview"
                                    className="h-24 w-auto rounded-md border object-cover shadow-sm"
                                    onError={(e) => {
            ...
            case 'date':
                if (mode === 'view') {
                    return <div className="rounded-md border bg-gray-50 p-2">{value ? new Date(value).toLocaleDateString() : '-'}</div>;
                }
                return (
                    <Input
                        {...commonProps}
                            ...
                            {fields.map((field) => (
                                ...
                                >
                                    <Label htmlFor={field.name}>
                                        {field.label}
                                        {field.required && mode !== 'view' && <span className="ml-1 text-red-500">*</span>}
                                    </Label>
                                    {renderField(field)}
